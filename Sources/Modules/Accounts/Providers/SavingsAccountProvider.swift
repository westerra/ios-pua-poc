...
enum SavingsAccountProvider {
    ...
    static func getDetails(for account: SavingsAccount) -> [AccountDetailsSection] {
...
// MARK: Helper Methods
private extension SavingsAccountProvider {
    ...
    static func getBalanceDetails(for account: SavingsAccount) -> [AccountDetailsRow] {
    ...
    /// - Parameter account: The account used to pull the details
    /// - Returns: Array of the requested account details
    static func getGeneralDetails(for account: SavingsAccount) -> [AccountDetailsRow] {
