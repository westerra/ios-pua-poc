...
enum GeneralAccountProvider {
    ...
    static func getDetails(for account: GeneralAccount) -> [AccountDetailsSection] {
...
// MARK: Helper Methods
private extension GeneralAccountProvider {
    ...
    static func getBalanceDetails(for account: GeneralAccount) -> [AccountDetailsRow] {
    ...
    /// - Parameter account: The account used to pull the details
    /// - Returns: Array of the requested account details
    static func getGeneralDetails(for account: GeneralAccount) -> [AccountDetailsRow] {
